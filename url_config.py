...
class CatUrlConfig:
    ...
    def __init__(self):
        if not self._initialized:
            ...
            self.base_url = "https://api.chenyuenode.com"  # 修改为新的域名
            self.login_api_url = f"{self.base_url}/api/login"
            self.upload_api_url = f"{self.base_url}/api/upload"
            self.serial_api_url = f"{self.base_url}/api/serial"
